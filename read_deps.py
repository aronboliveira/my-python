...
def extract_file_deps(file: str, _case: str) -> None:
    ...
    def evaluate_version(d: str, exist_v: str, load_v: str) -> bool:
      """
			Compares the versions of the evaluated dependency to check if it should be replaced or not is the listing
			:param str d: the name of the dependency
			:param str exist_v: the already listed version of the dependency
			:param str load_v: the loaded version of the dependency, to be evaluated
			:return bool indicating whether or not the dependency version value should be overriden
      """
